const styles = {
  ...
  heading: 'text-xl py-3 border-t font-Sora font-semibold md:py-4 md:mb-4',
  section: 'lg:container px-4 max-w-7xl mx-auto mt-4 mb-6',
  ...
  auth_button:
    'flex rounded-lg border gap-2 h-[50px] w-full justify-center items-center',
  cart_button:
  ...
  auth_input:
    'w-full h-full rounded outline-none pl-9 border border-[#00000034] focus:border-[#007BFF] focus:border-2 peer ',
  activeStatus:
